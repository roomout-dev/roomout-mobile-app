...
namespace GoogleARCore.Examples.ObjectManipulation
{
    ...
    /// </summary>
    public class SelectionManipulatorTreasureChest : Manipulator
    {
        /// <summary>
        ...
        protected override void OnSelected()
        {
            ...
            GameObject.Find("TreasureHandler").GetComponent<TreasureHandler>().SelectChest();
        }
        ...
        protected override void OnDeselected()
        {
            ...
            GameObject.Find("TreasureHandler").GetComponent<TreasureHandler>().DeselectChest();
        }
    }
}
